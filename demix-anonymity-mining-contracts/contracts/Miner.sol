...
import "demix-trees-contracts/contracts/DeMixTrees.sol";
...
contract Miner is EnsResolve {
  ...
  constructor(
    ...
    demixTrees = DeMixTrees(resolve(_demixTrees));
  ...
  function reward(
    ...
    demixTrees.validateRoots(_args.depositRoot, _args.withdrawalRoot);
  ...
  function setDeMixTreesContract(DeMixTrees _demixTrees) external onlyGovernance {
