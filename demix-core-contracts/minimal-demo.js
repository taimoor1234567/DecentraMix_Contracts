...
const PRIVATE_KEY = '' // TODO: Add Private Key
const CONTRACT_ADDRESS = '' // TODO: Add Contract Address of 0.1 BNB - DeMixFactory (Testnet)
const AMOUNT = '0.1'
// CURRENCY = 'BNB'
...
async function deposit() {
  ...
  return `demix-eth-${AMOUNT}-${netId}-${toHex(deposit.preimage, 62)}`
}
...
async function main() {
  ...
  contract = new web3.eth.Contract(require('./build/contracts/DeMixFactory.json').abi, CONTRACT_ADDRESS)
