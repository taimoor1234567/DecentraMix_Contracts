...
import { DeMixPool__factory as DeMixPool, OffchainOracle__factory as OffchainOracle } from '@/artifacts';
...
export class ProviderService {
  ...
  getDeMixPool() {
    return DeMixPool.connect(CONTRACT_NETWORKS[this.chainId], this.provider);
  }
