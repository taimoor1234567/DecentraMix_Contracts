...
contract('Airdrop', (accounts) => {
  ...
  before(async () => {
    ...
    dewo = await Dewo.new(accounts[0], 0, [{ to: newAddr, amount: cap }])
  ...
  describe('#airdrop', () => {
    it('should work', async () => {
      ...
      const bal1 = await dewo.balanceOf(recipient1)
      const bal2 = await dewo.balanceOf(recipient2)
    ...
    //   await Airdrop.new(dewo.address, [accounts[1], accounts[2]], [half, half], { from: airdropDeployer })
    // })
  })
