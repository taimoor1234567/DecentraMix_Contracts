...
module.exports = {
  ...
  demixTrees: { address: 'demix-trees-contracts.contract.tornadocash.eth', levels: 20 },
  demixProxy: { address: 'tornado-proxy.contract.tornadocash.eth' },
  demixProxyLight: { address: '0x0D5550d52428E7e3175bfc9550207e4ad3859b17' },
  ...
  demixStakingRewards: { address: 'staking-rewards.contract.tornadocash.eth' },
  relayerRegistry: { address: 'relayer-registry-contract.contract.tornadocash.eth' },
  demixRouter: { address: 'tornado-router.contract.tornadocash.eth' },
