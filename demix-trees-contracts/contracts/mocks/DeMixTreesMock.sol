...
contract DeMixTreesMock is DeMixTrees {
  ...
  ) public DeMixTrees(_governance, _demixTreesV1, _searchParams) {}
  ...
  function findArrayLengthMock(
    ...
    return findArrayLength(_demixTreesV1, _type, _from, _step);
  }
  ...
  function findArrayLength(
    ...
    return super.findArrayLength(_demixTreesV1, _type, _from, _step);
  }
}
